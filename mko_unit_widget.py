...
class Ui_Frame(object):
    def setupUi(self, Frame):
        ...
        self.AWLabel.setGeometry(QtCore.QRect(80, 80, 21, 21))
        self.AWLabel.setObjectName("AWLabel")
        self.RWBox = QtWidgets.QComboBox(Frame)
        self.RWBox.setGeometry(QtCore.QRect(170, 80, 71, 20))
        self.RWBox.setObjectName("RWBox")
        self.RWBox.addItem("")
        self.RWBox.addItem("")
        self.AddrSpinBox = QtWidgets.QSpinBox(Frame)
        self.AddrSpinBox.setGeometry(QtCore.QRect(40, 40, 42, 22))
        ...
        self.SubaddrLabel.setGeometry(QtCore.QRect(100, 40, 51, 21))
        ...
        self.AddresLabel.setGeometry(QtCore.QRect(0, 40, 41, 21))
        self.AddresLabel.setObjectName("AddresLabel")
        self.label = QtWidgets.QLabel(Frame)
        self.label.setGeometry(QtCore.QRect(0, 10, 21, 21))
        self.label.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        self.label.setObjectName("label")
        self.line = QtWidgets.QFrame(Frame)
        self.line.setGeometry(QtCore.QRect(10, 115, 721, 15))
